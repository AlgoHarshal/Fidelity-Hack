...
const detectPersona = (events, score, totalTimeSpent, exitCount) => {
  ...
  // Researcher: high time + many visits + no invest clicks
  ...
  // Confused Beginner: SIP focus, low score, no invest action
